...
test_that("Summary functions work", {
  ...
  expect_equal(
    ...
    c("Call:"                                                                                       ,
      ...
      "lnorm-aft      2/8       0.167       0.000            10.031"                                ,
      "llogis-aft     2/8       0.167       0.003             4.370"                                ,
      ""                                                                                            ,
      "Components summary:"                                                                         ,
      "       Models Prior prob. Post. prob. log(Exclusion BF)"                                     ,
      "x_fac3    4/8       0.500       0.189             1.454"                                     ,
      ""                                                                                            ,
      "Model-averaged estimates:"                                                                   ,
      "           Mean Median    0.1   0.5   0.9"                                                   ,
      "x_cont    0.055  0.055 -0.035 0.055 0.143"                                                   ,
      "x_fac3[B] 0.053  0.016 -0.076 0.016 0.282"                                                   ,
      "x_fac3[C] 0.094  0.050 -0.046 0.050 0.378"                                                   ,
      ""                                                                                            ,
      "Conditional estimates:"                                                                      ,
      "           Mean Median    0.1   0.5   0.9"                                                   ,
      "x_cont    0.055  0.055 -0.035 0.055 0.143"                                                   ,
      "x_fac3[B] 0.292  0.285  0.147 0.285 0.448"                                                   ,
      "x_fac3[C] 0.392  0.385  0.227 0.385 0.564"
      )
  )
  ...
  expect_equal(
    ...
    c("Call:"                                                            ,
      ...
      "exp-aft        1/5       0.200       0.852       23.103"          ,
      "weibull-aft    1/5       0.200       0.062        0.265"          ,
      "lnorm-aft      1/5       0.200       0.000        0.000"          ,
      "llogis-aft     1/5       0.200       0.001        0.004"          ,
      "gamma-aft      1/5       0.200       0.084        0.369"          ,
      ""                                                                 ,
      "Conditional estimates:"                                           ,
  ...
  expect_equal(
    ...
    c("Call:"                                                                           ,
      ...
      "Distributions summary:"                                                          ,
      "            Models Prior prob. Post. prob. Inclusion BF"                         ,
      "exp-aft        1/5       0.200       0.842       21.294"                         ,
      "weibull-aft    1/5       0.200       0.067        0.287"                         ,
      "lnorm-aft      1/5       0.200       0.000        0.000"                         ,
      ...
      "x_cont     0.059  0.059 -0.078 0.196     1.061       1.061      0.925      1.216",
      "x_bin[1]  -0.173 -0.175 -0.447 0.097     0.841       0.840      0.640      1.102",
      "x_fac3[B]  0.099  0.099 -0.242 0.433     1.104       1.104      0.785      1.542",
      "x_fac3[C]  0.255  0.252 -0.083 0.596     1.290       1.287      0.921      1.814",
      ""                                                                                ,
      "Distribution estimates (intercept):"                                             ,
      "             Mean Median  0.025 0.975"                                           ,
      "exp-aft     0.521  0.519  0.265 0.769"                                           ,
      "weibull-aft 0.522  0.518  0.242 0.814"                                           ,
      "lnorm-aft   0.024  0.026 -0.307 0.351"                                           ,
      "llogis-aft  0.022  0.022 -0.278 0.323"                                           ,
      "gamma-aft   0.563  0.556  0.225 0.933"                                           ,
      ""                                                                                ,
      "Distribution estimates (auxiliary):"                                             ,
      "             Mean Median 0.025 0.975"                                            ,
      "weibull-aft 0.968  0.968 0.867 1.074"                                            ,
      "lnorm-aft   1.473  1.470 1.336 1.625"                                            ,
      "llogis-aft  1.244  1.242 1.106 1.394"                                            ,
      "gamma-aft   0.971  0.970 0.832 1.123"
      )
  )
...
test_that("Models summary functions work", {
  ...
  expect_equal(
    ...
    c("Call:"                                                                                                              ,
      ...
      "     1    gamma-aft      N(0, 1) treatment contrast: U(-0.1, 0.1)       0.250      -320.81       0.739        8.514",
      ...
      "     4   llogis-aft      N(0, 1) treatment contrast: U(-0.1, 0.1)       0.083      -326.19       0.001        0.012",
      "     5    gamma-aft      N(0, 1)      treatment contrast: B(3, 3)       0.250      -322.26       0.174        0.633",
      "     6  weibull-aft      N(0, 1)      treatment contrast: B(3, 3)       0.083      -323.69       0.014        0.154",
  ...
  expect_equal(
    ...
    c("Call:"                                                                                                       ,
      ...
      "     1      exp-aft                                              0.100      -317.64       0.601       13.570",
      "     2  weibull-aft                                              0.100      -320.25       0.044        0.412",
      "     3    lnorm-aft                                              0.100      -329.97       0.000        0.000",
      "     4   llogis-aft                                              0.100      -324.44       0.001        0.006",
      "     5    gamma-aft                                              0.100      -319.95       0.060        0.570",
      "     6      exp-aft orthonormal contrast: mNormal(0, 0.25)       0.100      -318.51       0.250        3.001",
      ...
      "    10    gamma-aft orthonormal contrast: mNormal(0, 0.25)       0.100      -320.82       0.025        0.231"
    ))
})
