...
test_that("Model preview & set-up works", {
  ...
  expect_equal(
    ...
    c("Robust Bayesian survival analysis (set-up)"                                                                        ,
      ...
      "     1      exp-aft    Normal(0, 5)                 None     Spike(0)                         Spike(0)       0.050",
      "     2  weibull-aft    Normal(0, 5) Normal(0, 1)[0, Inf]     Spike(0)                         Spike(0)       0.050",
      "     3    lnorm-aft    Normal(0, 5) Normal(0, 1)[0, Inf]     Spike(0)                         Spike(0)       0.050",
      "     4   llogis-aft    Normal(0, 5) Normal(0, 1)[0, Inf]     Spike(0)                         Spike(0)       0.050",
      "     5    gamma-aft    Normal(0, 5) Normal(0, 1)[0, Inf]     Spike(0)                         Spike(0)       0.050",
      "     6      exp-aft    Normal(0, 5)                 None Normal(0, 1)                         Spike(0)       0.050",
      "     7  weibull-aft    Normal(0, 5) Normal(0, 1)[0, Inf] Normal(0, 1)                         Spike(0)       0.050",
      "     8    lnorm-aft    Normal(0, 5) Normal(0, 1)[0, Inf] Normal(0, 1)                         Spike(0)       0.050",
      "     9   llogis-aft    Normal(0, 5) Normal(0, 1)[0, Inf] Normal(0, 1)                         Spike(0)       0.050",
      "    10    gamma-aft    Normal(0, 5) Normal(0, 1)[0, Inf] Normal(0, 1)                         Spike(0)       0.050",
